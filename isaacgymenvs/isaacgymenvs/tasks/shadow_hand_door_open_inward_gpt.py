...
class ShadowHandDoorOpenInwardGPT(VecTask):
    ...
    def compute_reward(self, actions):
        self.rew_buf[:], self.rew_dict = compute_reward_gpt(self.left_hand_pos, self.right_hand_pos, self.left_hand_rot, self.right_hand_rot, self.door_left_handle_pos, self.door_right_handle_pos, self.door_left_handle_rot, self.door_right_handle_rot) 
