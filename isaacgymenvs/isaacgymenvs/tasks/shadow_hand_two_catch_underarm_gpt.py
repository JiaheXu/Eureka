...
class ShadowHandTwoCatchUnderarmGPT(VecTask):
    ...
    def compute_reward(self, actions):
        ...
        # def compute_reward_gpt(object_pos: torch.Tensor, goal_pos: torch.Tensor, object_another_pos: torch.Tensor, goal_another_pos: torch.Tensor) -> Tuple[torch.Tensor, Dict[str, torch.Tensor]]:
