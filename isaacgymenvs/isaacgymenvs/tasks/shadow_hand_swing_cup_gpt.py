...
class ShadowHandSwingCupGPT(VecTask):
    ...
    def compute_reward(self, actions):
        self.rew_buf[:], self.rew_dict = compute_reward_gpt(self.object_pos, self.object_rot, self.object_linvel, self.cup_right_handle_pos, self.cup_left_handle_pos, self.left_hand_pos, self.right_hand_pos, self.goal_pos, self.goal_rot) 
