...
class ShadowHandReOrientationGPT(VecTask):
    ...
    def compute_reward(self, actions):
        self.rew_buf[:], self.rew_dict = compute_reward_gpt(self.object_rot, self.goal_rot, self.object_another_rot, self.goal_another_rot) 
        self.extras['gpt_reward'] = self.rew_buf.mean()
        for rew_state in self.rew_dict: self.extras[rew_state] = self.rew_dict[rew_state].mean()
        # def compute_reward_gpt(object_rot: torch.Tensor, goal_rot: torch.Tensor,
