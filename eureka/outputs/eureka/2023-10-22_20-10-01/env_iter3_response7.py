...
def compute_reward_v4(object_rot: torch.Tensor, goal_rot: torch.Tensor, 
    ...
    dof_force_penalty = torch.std(torch.square(dof_force_tensor), dim=1)
    amplified_dof_force_penalty = torch.sqrt(dof_force_penalty)
    normalized_dof_force_penalty = amplified_dof_force_penalty / torch.max(amplified_dof_force_penalty)
