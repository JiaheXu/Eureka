...
def compute_reward_v4(object_rot: torch.Tensor, goal_rot: torch.Tensor, 
    ...
    normalized_angvel_penalty = angvel_penalty / torch.max(angvel_penalty)
    angvel_reward = torch.exp(-angvel_reward_temp * normalized_angvel_penalty)
    ...
    normalized_dof_force_penalty = dof_force_penalty / torch.max(dof_force_penalty)
    force_reward = torch.exp(-force_reward_temp * normalized_dof_force_penalty)
