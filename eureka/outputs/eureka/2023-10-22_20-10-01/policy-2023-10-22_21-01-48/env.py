...
class ShadowHandGPT(VecTask):
    ...
    def compute_reward(self, actions):
        self.rew_buf[:], self.rew_dict = compute_reward_improved(self.object_rot, self.goal_rot, self.object_angvel)
...
def compute_reward_improved(object_rot: torch.Tensor, goal_rot: torch.Tensor, 
    ...
    # Penalize large angular velocities (decrease the temperature parameter)
