...
def compute_reward_v3(object_rot: torch.Tensor, goal_rot: torch.Tensor, 
    ...
    force_reward_temp = torch.tensor(0.05, device=device) # increase the temperature parameter
    force_penalty = torch.mean(torch.abs(dof_force_tensor), dim=1) # use mean of absolute values of dof_force_tensor
