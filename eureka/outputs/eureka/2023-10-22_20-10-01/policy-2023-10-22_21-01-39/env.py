...
def compute_reward(object_rot: torch.Tensor, goal_rot: torch.Tensor, 
    ...
    angvel_reward_temp = torch.tensor(0.015, device=device)
    ...
    force_reward_temp = torch.tensor(0.005, device=device)
    force_penalty = torch.sum(torch.square(dof_force_tensor), dim=1) / 1000  # Rescale force_penalty
