...
def compute_reward_v4(object_rot: torch.Tensor, goal_rot: torch.Tensor, 
    ...
    force_reward_temp = torch.tensor(1.0, device=device) # increased temperature parameter
    force_weight = torch.tensor(0.5, device=device) # introduced force_weight term
    ...
    force_reward = torch.exp(-force_reward_temp * force_weight * normalized_dof_force_penalty)
