...
def compute_reward_v4(object_rot: torch.Tensor, goal_rot: torch.Tensor, 
    ...
    dof_force_THRESHOLD = torch.tensor(0.5, device=device)  # introducing a threshold for penalizing force
    force_penalty_mask = dof_force_penalty > dof_force_THRESHOLD
    normalized_dof_force_penalty = torch.masked_select(dof_force_penalty, force_penalty_mask)
