...
def compute_reward_v4(object_rot: torch.Tensor, goal_rot: torch.Tensor, 
    ...
    dof_force_penalty = torch.mean(torch.square(dof_force_tensor), dim=1)
    squared_dof_force_penalty = dof_force_penalty * dof_force_penalty # introduce squared term
    normalized_squared_dof_force_penalty = squared_dof_force_penalty / torch.max(squared_dof_force_penalty)
    force_reward = torch.exp(-force_reward_temp * normalized_squared_dof_force_penalty)
