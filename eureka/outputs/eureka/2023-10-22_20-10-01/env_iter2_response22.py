...
def compute_reward_v3(object_rot: torch.Tensor, goal_rot: torch.Tensor, 
    ...
    force_penalty_squared = torch.square(dof_force_tensor)
    force_penalty = torch.mean(torch.exp(-force_reward_temp * force_penalty_squared), dim=1)
    force_reward = 1.0 - force_penalty
