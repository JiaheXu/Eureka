...
def compute_reward_v3(object_rot: torch.Tensor, goal_rot: torch.Tensor,
    ...
    force_reward_temp = torch.tensor(0.05, device=device)  # increased the temperature parameter
    force_penalty = torch.sum(torch.square(dof_force_tensor), dim=1)  # simplified calculation of penalty
