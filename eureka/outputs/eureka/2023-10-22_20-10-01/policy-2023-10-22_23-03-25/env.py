...
def compute_reward_v5(object_rot: torch.Tensor, goal_rot: torch.Tensor, 
    ...
    # Penalize high forces within the force_limit constraint
    force_reward_temp = torch.tensor(0.01, device=device)       
    force_penalty = torch.where(force_magnitude <= force_limit, force_magnitude, torch.tensor(0.0, device=device))
