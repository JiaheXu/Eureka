...
def compute_reward_v4(object_rot: torch.Tensor, goal_rot: torch.Tensor, 
    ...
    dof_force_penalty_norm = dof_force_penalty / torch.clamp(torch.max(dof_force_penalty), min=1.0)
    force_reward = torch.exp(-force_reward_temp * dof_force_penalty_norm)
