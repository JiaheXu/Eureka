...
def compute_reward_v4(object_rot: torch.Tensor, goal_rot: torch.Tensor, 
    ...
    force_threshold = torch.tensor(1.0, device=device) # Introduce threshold for force penalty
    force_penalty = torch.where(force_penalty > force_threshold, force_penalty, torch.zeros_like(force_penalty))
