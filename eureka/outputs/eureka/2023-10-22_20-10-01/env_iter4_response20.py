...
def compute_reward_v5(object_rot: torch.Tensor, goal_rot: torch.Tensor, 
    ...
    # Compute the force magnitude and use a soft constraint for the force_limit (updated component)
    ...
    force_reward_temp = torch.tensor(0.01, device=device)  # introduce a new temperature parameter for the force reward
    force_penalty = torch.relu(force_magnitude - force_limit)  # penalty is applied when force_magnitude exceeds force_limit
